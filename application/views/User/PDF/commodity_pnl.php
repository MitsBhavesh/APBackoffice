...
$pdf->cell(195,7,"Profit/Loss Report for Commodity From ".$final_convert_date_new_fromdate." TO ".$final_convert_date_new_todate_fo."  FY [".$year1." - ".$year2."]",1,0,'C');
...
$pdf->ln();
$pdf->Cell(97.5,7,'CTT',1,0);
if(isset($_SESSION['APBackOffice_CTT']))
{
    $pdf->Cell(97.5,7,$_SESSION['APBackOffice_CTT'],1,0);
}
else
{
    $pdf->Cell(97.5,7,"0",1,0);
...
if(isset($_SESSION['APBackOffice_TURN_OVER_CHARGE'])){
    ...
    $total_charges=$_SESSION['APBackOffice_TURN_OVER_CHARGE']+$_SESSION['APBackOffice_CTT']+$_SESSION['APBackOffice_CGST']+$_SESSION['APBackOffice_SGST']+$_SESSION['APBackOffice_STAMP_DUTY']+$_SESSION['APBackOffice_SEBI_FEES']+$_SESSION['APBackOffice_CLEARING_CHARGES'];
...
if(isset($_SESSION['ApbackOffice_client_JV_charges_com_profit_and_loss']))
{
    $pdf->Cell(97.5,7,Ledger_balance($_SESSION['ApbackOffice_client_JV_charges_com_profit_and_loss']),1,0);
}
else
{
    $pdf->Cell(97.5,7,"-",1,0);
...
if(isset($_SESSION['ApbackOffice_client_R_charges_com_profit_and_loss']))
{
    $pdf->Cell(97.5,7,Ledger_balance($_SESSION['ApbackOffice_client_R_charges_com_profit_and_loss']),1,0);
}
else
{
    $pdf->Cell(97.5,7,"-",1,0);
...
if(isset($_SESSION['ApbackOffice_client_P_charges_com_profit_and_loss']))
{
    $pdf->Cell(97.5,7,Ledger_balance($_SESSION['ApbackOffice_client_P_charges_com_profit_and_loss']),1,0);
}
else
{
    $pdf->Cell(97.5,7,"-",1,0);
...
$pdf->Cell(11.8,7,'CL Price',1,0);
$pdf->Cell(14,7,'Notional',1,0);
$pdf->Cell(13.9,7,'Net P&L',1,0);
...
$pdf->Cell(11.8,7,'',1,0);
$pdf->Cell(11.8,7,'',1,0);
$pdf->Cell(14,7,$total_Notional_future,1,0);
$pdf->Cell(13.9,7,$total_future,1,0);
}
if ($commodity_option_data=="1") 
{
//Option
$pdf->AddPage();
...
$pdf->Cell(11.8,7,'',1,0);
$pdf->Cell(11.8,7,'',1,0);
$pdf->Cell(14,7,$total_Notional_option,1,0);
$pdf->Cell(13.9,7,$total_options,1,0);
}

$pdf->Output('I',$data[0]."_Commodity_PNL.pdf");

date_default_timezone_set('Asia/Kolkata');
$localIp = gethostbyname(gethostname());
$myfile2 = fopen("Commodity_pnl_log.txt", "a") or die("Unable to open file!");
