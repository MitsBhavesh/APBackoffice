...
$year1 = $split_date[2];
$split_date1 = explode("/", $final_convert_date_new_todate_ledger);
$year2 = $split_date1[2];
$pdf->cell(195,7,"Profit/Loss Report For Ledger From ".$final_convert_date_new_fromdate." TO ".$final_convert_date_new_todate_ledger."  FY [".$year1." - ".$year2."]",1,0,'C');
...
foreach ($ledger_PNL as $key => $value) 
{
    ...
    {
        if($ledger_PNL[$i][1] != "0" || $ledger_PNL[$i][2] != "0")
        {
        ...
        $pdf->SetFont('Arial','', 7);
        //Trading Date
        $pdf->Cell(14,$cell_htg,($ledger_PNL[$i][19] != " " && $ledger_PNL[$i][19] != "")?date_format(date_create(str_replace(",", "", $ledger_PNL[$i][19])),"Y/m/d"):"",1);
        //Voucher Date
...
// ######################### END Ledger
$pdf->Output('I',"LEDGER_PNL.pdf");
date_default_timezone_set('Asia/Kolkata');
$myfile2 = fopen("ledger_pnl_log.txt", "a") or die("Unable to open file!");
