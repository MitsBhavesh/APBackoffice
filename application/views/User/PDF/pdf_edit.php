<?php
if(isset($_SESSION['Arham_client_client_master_data']))
{
...
$pdf->AddPage();
//set the source file
$pdf->setSourceFile('E:\ArhamBackOffice_PDF\ClientMaster.pdf');
...
$pdf->Output('D', $_SESSION['Arham_User_Session_Data'][9].'_Client_Details.'.'pdf');
?>
