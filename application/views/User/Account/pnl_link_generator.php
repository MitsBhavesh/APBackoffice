                           ...
                           <div class="row">
                              <div class="col-xl-12">
                                 <div class="card-header"
                                    ...
                                    <h6 class="card-title" style="color:#ffff!important;"><i class="fas fa-rupee-sign me-2"
                                       style="color: #ffff;"></i>PNL Link Generator</h6>
                                 </div>
                                 <div class="card-body">
                                    <div class="row">
                                       <div class="col-4">
...
<script>
   function create_link(argument) 
   {
      ...
      $.ajax({
          type: "POST",
          url: '<?php echo base_url(); ?>Accounts/createlink_pnl',
...
<script>
   function send_mail()
   {
      ...
      $.ajax({
         type: "POST",
         url: '<?php echo base_url(); ?>Accounts/send_mail',
