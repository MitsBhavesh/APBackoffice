...
<div class="alert alert-success alert-border-left alert-dismissible fade show" role="alert">
    <i class="mdi mdi-check-all me-3 align-middle"></i><strong>
        <?php echo $_SESSION['APBackOffice_success']; ?></strong>
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
...
if(!empty($_SESSION['APBackOffice_info']))
 {
//echo "login";
 ?>
<!--  <div class="alert alert-success alert-dismissible fade show mb-0" role="alert">
    ...
    <?php echo $_SESSION['APBackOffice_info']; ?>
  </div> -->
<div class="alert alert-info alert-border-left alert-dismissible fade show" role="alert">
    <i class="mdi mdi-information-variant align-middle"></i><strong>
        <?php echo $_SESSION['APBackOffice_info']; ?></strong>
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>

<?php
  unset($_SESSION['APBackOffice_info']);
}
