...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login | APBackOffice | Sub-Broker</title>
                    ...
                    <div class="auth-bg pt-md-5 p-4 d-flex">
                        ...
                        <div class="col-xxl-3 col-lg-4 col-md-5"
                            ...
                            <div class="auth-full-page-content d-flex p-sm-5 p-4"
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="auth-content my-auto"
                                            ...
                                            <div class="text-center">
                                                ...
                                                <p class="text-muted mt-2">Sign in to continue to this panel.</p>
                                                
                                            </div>
                                            
                                            <?php include("alert.php"); ?>
                                            <form id="myformlogin" method="post"
                                                action="<?php echo base_url('APBackOffice/Login'); ?>">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <small class="text-muted form-text fw-semibold" id="error_password"
                                                ...
                                                <div class="text-center">
                                                        ...
                                                        <a href="<?php echo base_url('APBackOffice/Forgot_Password'); ?>"
                              ...
                              <p>Note: Branch code must be case-sensitive.</p>
                           </div>
                                        </div>
                                    </div>
                                </div>
