               ...
               <div class="card border-primary">
                  <div class="card-header" style="background-color: #0b5639!important;padding: 9px!important;">
                     <h6 class="card-title" style="color:#ffff!important;"><i class="mdi mdi-digital-ocean me-3"
                        style="color: #ffff;"></i>Festival Post</h6>
                  </div>
                  <div class="card-body">
                     <div class="row">
                        <!-- Festival Post -->
                        ...
                        <div class="col-md-6 col-xl-4">
                           <div class="card">
                                 <div class="card-body">
                                    <ul id="lightgallery_f<?php echo $i;?>" class="list-unstyled row">
                                    <li data-src="<?php echo base_url();?>assets/images/small/Festival_post/<?php echo $value['File_name'];?>"
                                        ...
                                        data-pinterest-text="Pin it1" data-tweet-text="share on twitter 1">
                                            <img class="card-img-top img-fluid box1 "
                                                src="<?php echo base_url();?>assets/images/small/Festival_post/<?php echo  $value['File_name'];?>"
                                                alt="Thumb-1">
                           ...
                           <script>
                              lightGallery(document.getElementById('lightgallery_f<?php echo $i;?>'));
                           </script>
                           <?php $i++;}?>
                     </div>
                  </div>
